...
TEST(CircuitTester, DialaTest) {
    ...
    pdbnames2[0] = "./test/input/CircuitFinder/DIALA.pdb";
    pdbnames2[1] = "./test/input/CircuitFinder/DIALA.pdb";
    ...
    */
    ...
    psfnames2[0] = "./test/input/CircuitFinder/DIALA.psf";
    psfnames2[1] = "./test/input/CircuitFinder/DIALA.psf";
...
TEST(CircuitTester, MBHemeTest) {

    config_setup::RestartSettings rs2;

    std::string pdbnames2[2];

    pdbnames2[0] = "./test/input/CircuitFinder/MYO_HEME_WT_ALIGNED.pdb";
    pdbnames2[1] = "./test/input/CircuitFinder/MYO_HEME_WT_ALIGNED.pdb";
    ...
    /*
        Let GOMC parse MYOGLOBIN
    */

    psfnames2[0] = "./test/input/CircuitFinder/MYO_HEME_WT_ALIGNED.psf";
    psfnames2[1] = "./test/input/CircuitFinder/MYO_HEME_WT_ALIGNED.psf";
