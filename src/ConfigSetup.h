...
struct FFValues {
  ...
  static const std::string WOLF_VLUGT, WOLF_GROSS, WOLF_HYBRID, WOLF_VLUGTWINTRACUTOFF;
  static const uint COUL_DSP_KIND, COUL_DSF_KIND;
  static const uint WOLF_VLUGT_KIND, WOLF_GROSS_KIND, WOLF_HYBRID_KIND, WOLF_VLUGTWINTRACUTOFF_KIND;
};
