...
inline double FF_SWITCH_MARTINI::CalcCoulomb(const double distSq, const double qi_qj_Fact,
                                              const uint b,
                                              double rCutCoulomb,
                                              double wolfFactor1, 
                                              double wolfFactor2,
...
inline double FF_SWITCH_MARTINI::CalcCoulombVir(const double distSq, const double qi_qj,
                                       uint b,
                                       double wolfFactor2,
                                      double wolfFactor3,
                                      double wolfAlpha) const
