...
void CellListGPU::MapParticlesToCell(VariablesCUDA * cv,
    ...
    cudaMemcpy(&testval2, molLookupRef.molLookupGPU->gpu_molLookup, 1 * sizeof(int), cudaMemcpyDeviceToHost);
    cudaMemcpy(&testva3, molLookupRef.molLookupGPU->gpu_startAtomIdx, 1 * sizeof(int), cudaMemcpyDeviceToHost);
